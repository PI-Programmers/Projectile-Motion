...
c = 0.47
r = float(input("Enter The Projectile Radius : "))
A = np.pi * r**2
m = float(input("Enter The Projectile Mass : "))
...
v0 = float(input("Enter The Projectile Lauch Velocity : "))
phi0 = np.radians(int(input("Enter The Projectile Angle : ")))
